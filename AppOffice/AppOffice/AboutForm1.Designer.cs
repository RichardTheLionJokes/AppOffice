namespace AppOffice
{
    partial class AboutForm1
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AboutForm1));
            ...
            // OK
            // 
            this.OK.Location = new System.Drawing.Point(358, 129);
            this.OK.Name = "OK";
            ...
            this.label1.Text = "Defect Creator 1.0.0.3";
            // 
            // label2
            // 
            ...
            this.label2.Text = "Автор: Сергей Скляр";
            // 
            // label3
            // 
            ...
            this.label3.Text = "Данная модная программа предназначена для\r\nформирования дефектных ведомостей\r\nсот" +
    "рудниками АмГПГУ";
            // 
            // AboutForm1
            // 
